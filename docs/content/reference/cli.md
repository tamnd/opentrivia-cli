...
```
opentrivia <command> [arguments] [flags]
```

Run `opentrivia <command> --help` for the full flag list on any command. This
...
per operation you declare in `opentrivia/domain.go`.
