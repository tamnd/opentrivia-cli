...
Most of these come down to network reality or how opentrivia serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

opentrivia rate-limits like any public site. opentrivia already paces
...
Where a surface is gated, opentrivia reads a cookie or token you supply
...
`opentrivia`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what opentrivia actually did
